...
sewerOption3 = Option.create(choice_value: `"Negotiate"`, script: sewerPathScript)

denyMoneyScript = Script.create(choice: `"I don't have anything for you."`, prompt: `"[combat] You must want to die then. Very well! "`)

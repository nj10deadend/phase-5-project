...
option2 = Option.create(choice_value: "Enter woods", script: startStoryScript)
...
negotiationDialogueOption1 = Option.create(choice_value: "Fine", script: negotiateScript)
negotiationDialogueOption2 = Option.create(choice_value: "What happened?", script: negotiateScript)
...
sewerPQuestionRealityScript = Script.create(choice: "Are you real?", prompt: "Am I real he says...(Both men laugh until the first one pulls out a dagger). How about this is this real enough for you? Hand it all over.", img: "", img2: "")

class CharactersController < ApplicationController
    ...
    def create
        ...
        if new_character.valid?
          ...
          byebug
          new_character_role = CharacterRole.create(character: new_character, role: params[:role])
          new_character_script = CharacterScript.create(character: new_character, script: params[:script])

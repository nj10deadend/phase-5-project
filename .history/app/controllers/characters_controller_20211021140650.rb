class CharactersController < ApplicationController
    ...
    def show 
      ...
      if your_character
        render json: your_character, serializer: CharacterShowSerializer, status: :found
      else
    ...
    def create
        ...
        if new_character.valid?
          ...
          new_character_script = CharacterScript.create(character: new_character, script_id: params[:script][:id])
